...
const GovernancePage: React.FC = () => {
    ...
    return (
        <div className="p-4 max-w-6xl mx-auto mt-20 md:mt-0">
            <h1 className="text-2xl sm:text-3xl font-bold text-center mb-6">College Governance</h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-6">
                <button
                    ...
                    className={clsx(
                        "px-4 py-2 rounded-full flex items-center justify-center gap-2 border text-sm sm:text-base",
                        tab === "board"
                            ? "bg-linear-to-r from-secondary-400 to-primary-500 text-white"
                            : "bg-gray-100 hover:bg-gray-200",
                    )}
                >
        ...
        {members?.map((member, idx) => (
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                {members?.map((member, idx) => (
                    <Card key={idx} shadow="sm" radius="md" padding="md" withBorder className="text-center ">
                        <div className="w-32 h-32 mx-auto rounded-md overflow-hidden">
                            <Image src={member.image} alt={member.name} className="w-full object-contain" />
                        </div>
