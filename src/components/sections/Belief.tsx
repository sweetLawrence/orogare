...
const Belief = () => {
  ...
  return (
    <div className='px-[4%] w-[100%] h-[47vh] bg-back-500'>
      ...
      <div className='cs flex justify-between'>
        ...
        <Card key={i} className='bg-white flex flex-row items-start !justify-between py-7 px-8 w-[32%] shadow-lg rounded-lg'>
