    ...
    return (
        <div className="px-[3%] w-full py-10 md:h-auto flex flex-col overflow-hidden">
            ...
            <Text className="text-text-500 max-w-5xl">
                Our programs are designed to equip students with industry-relevant skills, combining hands-on training
                and theoretical knowledge. Whether you are pursuing a <b>diploma, craft, artisan certification</b>, or a{" "}
                <b>short specialized course</b>, our curriculum ensures practical competence and career readiness.
            </Text>
            ...
            <Space h={20} />
            <Link className="m-auto" to={"/downloads"}>
